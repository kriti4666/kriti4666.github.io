...
const Statistics = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex border-2 h-auto w-4/5 justify-center align-center m-auto mt-8">
      ...
      <div className=" m-auto mt-14">
        <img src="https://github-readme-stats.vercel.app/api/top-langs?username=kriti4666&show_icons=true&locale=en&layout=compact&theme=white" alt='git-top lang'/>
      </div>
      <div className="flex gap-20  justify-center mt-14">
        ...
        {/* https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=kriti4666&theme=tokyonight */}
        <div>
          <img
            align="center"
